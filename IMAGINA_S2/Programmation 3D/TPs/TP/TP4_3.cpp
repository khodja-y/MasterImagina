...
long meridien = 8, angle = 0, parallele = 8;
...
void render_scene()
{
  ...
  long hauteur = 20, r = 20;
  Point* sommets = new Point[meridien*parallele*4];
  Point nord, sud;
  Point sommet;
  ...
  sommets = pointSphere(meridien, parallele, hauteur, r, sommet);

  glRotated(angle,1,0,0);
  glScaled(0.1,0.1,0.1);


  affichageSphere(sommets, meridien, parallele, nord, sud);
