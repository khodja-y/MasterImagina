...
patches-own [cpt-temps cpt-temps-init taille-herbe]
boeufs-own [energie]
...
to setup
  ...
  create-boeufs random initial-number-boeuf

  ask boeufs[
    set shape "sheep 2"
    setxy random-xcor random-ycor
    set color brown
    set energie consommation-herbe
  ]

  ask patches[
    ;;set cpt-temps-init taille-max-herbe
    set cpt-temps 0
    set pcolor black
    set taille-herbe 0
  ]
...
to regrouper
  ...
  ask boeufs[
    ...
    let p one-of other boeufs in-radius 5
    ...
    let d min-one-of other boeufs in-radius distance-min [distance myself]

    if (d != nobody)[ set heading towards (d) + 180]
...
to croissance
  ...
  ask patches[
      ...
      if taille-herbe < taille-herbe-max[
...
to quete-nourriture
  ...
  ask boeufs[
    if (pcolor = scale-color green taille-herbe 0 70)
    [set pcolor scale-color black taille-herbe 0 70
    set taille-herbe 0]
