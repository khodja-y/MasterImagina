 ...
 *
 *  un rÃ©seau de contrainte (X,D,C) est reprÃ©sentÃ© par :
 * 		- X les variables et D les domaines sont reprÃ©sentÃ©s par un ensemble de 
 ...
 *
 *  On pourra, pour optimiser la structure d'un rÃ©seau de contraintes, ajouter
 * une HashMap (variable, liste de contraintes) qui permet d'associer Ã 
...
public class Network {
	...
	public void addConstraint(Constraint c) {		
		...
		if(!varDom.keySet().containsAll(c.getVars())) // si l'une des variables de la contrainte n'existe pas dans le réseau
