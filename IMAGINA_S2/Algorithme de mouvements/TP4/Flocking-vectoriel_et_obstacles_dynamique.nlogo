...
to flock  ;; turtle procedure
  ...
  ifelse any? flockmates
    ...
    let v accelere
    set vitesse magnitude v
    set vitesse vitesse - frottement
  ]
...
to-report accelereObs

  let f multiplyScalarvect acceleration vectObstacles


  let x vitesse + item 0 f
  let y vitesse + item 1 f
...
to-report accelere
  ...
  let f multiplyScalarvect acceleration vectDirect
...
to-report frottement
  let p vitesse * vitesse * coeff-frottement
...
to find-obstacles
  set obstacles patches in-cone 9 90 with [pcolor = red]
end
...
; Copyright 1998 Uri Wilensky - 2015
; Modified J. Ferber for vector based behavior
